...
@Component
@NonnullByDefault
public final class TaskSourceManifestResolver {
  private final ManifestEvaluator manifestEvaluator;

  @Autowired
  public TaskSourceManifestResolver(ManifestEvaluator manifestEvaluator) {
    this.manifestEvaluator = manifestEvaluator;
  }

  ImmutableMap<String, Object> resolveManifests(Stage stage, ManifestContext context) {
